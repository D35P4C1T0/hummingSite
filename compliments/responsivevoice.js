  ...
  var ResponsiveVoice = function() {
      ...
      a.responsivevoices = [
        ...
        },
        {
          ...
          flag: "us",
          gender: "f",
          voiceIDs: [39, 40, 41, 42, 383, 205, 204, 43, 173, 235, 283, 339, 44]
        },
        {
        ...
        { name: "Arabic Female", flag: "ar", gender: "f", voiceIDs: [98] },
        ...
        { name: "Thai Male", flag: "th", gender: "m", voiceIDs: [403] },
        {
          name: "Turkish Female",
          flag: "tr",
          gender: "f",
        ...
        { name: "Turkish Male", flag: "tr", gender: "m", voiceIDs: [404] },
      ...
      a.is_opera =
        !!window.opera || 0 <= navigator.userAgent.indexOf("OPR/index.html")
              ...
              for (var f = b; f.length > a.CHARACTER_LIMIT; ) {
                ...
                if (-1 == g || g >= a.CHARACTER_LIMIT) {
                  ...
                  for (
                    g = 0;
                    g < l.length &&
                    !(e.length + l[g].length + 1 > a.CHARACTER_LIMIT);
                    g++
                  )
                    e += (0 != g ? " " : "") + l[g]
      ...
      a.mapRVs = function() {
        for (var b = 0; b < a.responsivevoices.length; b++)
          for (
            var c = a.responsivevoices[b], d = 0;
            d < c.voiceIDs.length;
            d++
          ) {
        ...
        if (!a.fallback_audiopool || 0 == a.fallback_audiopool.length) {
          for (var b = 0; 10 > b; b++) {
            ...
            a.iOS &&
              ...
              d.load(),
              9 == c &&
                (a.log("iOS HTML audio initialized"), (a.iOS_initialized = !0)))
